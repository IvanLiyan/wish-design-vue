<template>
  <wt-form ref="form" title="企业入驻" :rules="ruleCustom" :model="formData" :first-fields="true" class="form">
    ...
    <wt-form-item prop="name" helper="提现操作仅限于此真实姓名下的银行卡。" required>
    ...
    <wt-form-item prop="idFront" required>
      ...
      <span class="tip">可接受的文件类型：jpg, png, gif, pdf。文件大小不能超过20MB。</span>
    </wt-form-item>
