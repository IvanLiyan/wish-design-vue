<template>
  <div class="demo-modal-btn-groups">
    <wt-button type="primary" @click="openConfirm">确认信息</wt-button>
    <wt-button type="primary" @click="openInfoConfirm">信息提示</wt-button>
    ...
    <wt-button type="danger" @click="openDangerConfirm">失败提示</wt-button>
  </div>
</template>
