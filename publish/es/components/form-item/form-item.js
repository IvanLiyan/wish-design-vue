...
var __vue_render__ = function __vue_render__() {
  var _obj;
  var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('div', { class: _vm.classes }, [_vm.label || _vm.$slots.label ? _c('label', { class: _vm.prefix + "-label", style: _vm.labelStyles, attrs: { "for": _vm.labelFor } }, [_vm._t("label", function () {
    return [_vm._v(_vm._s(_vm.label) + _vm._s(_vm.labelSuffix))];
  })], 2) : _vm._e(), _c('div', { class: _vm.prefix + "-content", style: _vm.contentStyles }, [_vm._t("default"), _vm._v(" "), _vm.helperPlacement === 'right' ? _c('transition', { attrs: { "name": "fade-in" }, on: { "after-leave": _vm.handleAfterLeave } }, [_vm.helper || _vm.$slots.helper ? _c('div', { class: _vm.prefix + "-helper " + _vm.prefix + "-helper-right" }, [_vm._t("helper", function () {
    return [_vm._v(_vm._s(_vm.helper))];
  })], 2) : _vm._e()]) : _vm._e(), _vm._v(" "), _c('transition', { attrs: { "name": "fade-in" }, on: { "after-leave": _vm.handleAfterLeave } }, [_vm.showError ? _c('div', { class: (_obj = {}, _obj[_vm.prefix + "-error-tip"] = true, _obj[_vm.prefix + "-error-tip-right"] = _vm.validatePlacement === 'right', _obj) }, [_vm._t("error", function () {
    return [_vm.useHtmlMessage ? _c('div', { domProps: { "innerHTML": _vm._s(_vm.validateMessage) } }) : [_vm._v(_vm._s(_vm.validateMessage))]];
...
export default {
  ...
  computed: {
    ...
    classes: function classes() {
      ...
      return _ref = {}, _defineProperty(_ref, prefix, true), _defineProperty(_ref, prefix + '-required', this.required || this.isRequired), _defineProperty(_ref, prefix + '-error', error), _defineProperty(_ref, prefix + '-warning', validateState === 'warning'), _defineProperty(_ref, prefix + '-validating', this.validateState === 'validating'), _defineProperty(_ref, prefix + '-error-' + this.validatePlacement, isFadeIn), _defineProperty(_ref, prefix + '-' + this.$labelPosition, this.$labelPosition), _ref;
    },
